...
const NAV = [
  ...
  { to: '/ledger', label: 'Vault', icon: Vault, chip: 'bg-teal-100 text-teal-700' },
  { to: '/cash', label: 'FETS Cash', icon: Wallet, chip: 'bg-orange-100 text-orange-700' },
  { to: '/recurring', label: 'Recurring', icon: CalendarClock, chip: 'bg-indigo-100 text-indigo-700' },
  { to: '/reimburse', label: 'Reimburse', icon: HandCoins, chip: 'bg-pink-100 text-pink-700' },
